...
impl<R: gfx::Resources> ModelManager<R> {
    ...
    where C: gfx::CommandBuffer<R>
    {
        ...
        for (name, model) in &self.models {
            ...
            let light = g_object::Light {   lightPos: Vector3::new(10.0, 10.0, 10.0).into(),
                                            viewPos: camera.cameraPos.into(),
                                            lightColor: Vector3::new(1.0, 1.0, 1.0).into(),
                                            objectColor: Vector3::new(0.0, 0.0, 0.0).into(),
                                            _pad: 0.0,
                                        };
